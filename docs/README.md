...
The v1.1 binary requires macOS 26.1 or later and targets Apple Silicon.
...
The v1.1 download is ad-hoc signed. Right-click `fan.app`, choose Open, and confirm the standard macOS prompt.
